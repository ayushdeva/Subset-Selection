...
def main():
    ...
    for j in range(nrounds):
        n,alpha,R,Q,C = generate_inputs(n=n_input,alpha=alpha_inp)
        ...
        opt_allocation,excess_qual = env.get_optimal(0.0,'ilp')
        import pdb; pdb.set_trace()
        opt_allocation_margin,excess_qual_margin = env.get_optimal(error_margin_quality,'ilp')
        import pdb; pdb.set_trace()
